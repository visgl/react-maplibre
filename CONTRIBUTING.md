...
Building react-maplibre locally from the source requires node.js LTS.
...
react-maplibre follows the [Semantic Versioning](https://semver.org/) guidelines. Steps for publishing releases can be found [here](https://www.github.com/visgl/tsc/tree/master/developer-process).
...
react-maplibre development is governed by the vis.gl Technical Steering Committee (TSC).

### Maintainers

- [Xiaoji Chen](https://github.com/Pessimistress)

Maintainers of react-maplibre have commit access to this GitHub repository, and take part in the decision making process.
...
Please be mindful of and adhere to the Linux Foundation's [Code of Conduct](https://lfprojects.org/policies/code-of-conduct/) when contributing to react-maplibre.
