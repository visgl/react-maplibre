...
React component that wraps the base library's [Popup](https://maplibre.org/maplibre-gl-js/docs/API/classes/Popup/) class.
...
[popup.ts](https://github.com/visgl/react-maplibre/tree/1.0-release/src/components/popup.ts)
